...
We have received information that there are weapon caches on the island and there is a document on their whereabouts in a government building in the town of Meux. Command wants those weapons removed, and has given `A-2-0` the green-light to operate as they see fit.
## Mission
`A-2-0` is to Infiltrate the 'RU Embassy' to find out where the weapon caches are located. After gathering the intel, `A-2-0` is to regroup at FOB Weller-man to prepare assault to Search and Destroy the Logistic Elements.
## Assists
